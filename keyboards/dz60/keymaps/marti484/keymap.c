...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [L_QUICK] = LAYOUT_directional(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_DEL, KC_ESC, KC_PSCR, KC_SLCK, KC_PAUS, KC_SLEP, KC_NO, KC_BRID, KC_BRIU, KC_MRWD, KC_MPRV, KC_MPLY, KC_MNXT, KC_MFFD, KC_NO, KC_CAPS, KC_INS, KC_HOME, KC_PGUP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS, KC_TRNS, KC_DEL, KC_END, KC_PGDN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_APP, KC_TRNS, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT),
        [L_KEYPAD] = LAYOUT_directional(KC_ESC, KC_NO, KC_BTN3, KC_BTN4, KC_BTN5, KC_NO, KC_NO, KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, KC_ACL0, KC_ACL1, KC_NO, KC_BSPC, KC_NO, KC_BTN1, KC_MS_U, KC_BTN2, KC_NO, KC_NO, KC_NO, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_NO, KC_ACL2, KC_NO, TG(2), KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_PCMM, KC_PEQL, KC_PENT, KC_NO, KC_NO, KC_NO, KC_WH_L, KC_WH_D, KC_WH_R, KC_P0, KC_P1, KC_P2, KC_P3, KC_PDOT, KC_NO, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_SPC, KC_NO, KC_NO, LT(3,KC_NO), KC_LEFT, KC_DOWN, KC_RGHT),
